...
//create load balancer to accept TCP traffic from port 443 
...
//deployment:
//New-AzResourceGroup -Name tosoRG -Location "eastUS 2"
// New-AzResourceGroupDeployment -ResourceGroupName tosoRG -TemplateFile .\ilb.bicep
